...
$template = $GLOBALS["_template"]->loadTemplate("squads", "memberslist_title", $data_array, $plugin_path);
echo $template;
...
if ($action == "show") {
    ...
    if (mysqli_num_rows($ergebnis)) {
        while ($ds = mysqli_fetch_array($ergebnis)) {
            ...
            $template = $GLOBALS["_template"]->loadTemplate("squads", "memberslist_head_head", $data_array, $plugin_path);
            echo $template;
            ...
            $template = $GLOBALS["_template"]->loadTemplate("squads", "memberslist_head", $data_array, $plugin_path);
            echo $template;
            ...
            while ($dm = mysqli_fetch_array($member)) {
                ...
                if ($dm['activity']) {
                    $activity = '<span class="bg-success">' . $plugin_language['active'] . '</span>';
                } else {
                    $activity = '<span class="bg-warning text-dark">' . $plugin_language['inactive'] . '</span>';
                }
                ...
                if (file_exists("images/userpics/" . $profilid . ".jpg")) {
                    ...
                    $pic_info = $dm['nickname'] . " userpicture";
                } elseif (file_exists("images/userpics/" . $profilid . ".avif")) {
                    $userpic = $profilid . ".avif";
                    $pic_info = $dm['nickname'] . " userpicture";
                } elseif (file_exists("images/userpics/" . $profilid . ".webp")) {
                    $userpic = $profilid . ".webp";
                    $pic_info = $dm['nickname'] . " userpicture";
                } else {
                ...
                if (!empty(@$dn['squads'] == 1) !== false) {
                    ...
                    $template = $GLOBALS["_template"]->loadTemplate("squads", "memberslist_content_team_one", $data_array, $plugin_path);
                    echo $template;
                } else {


                    $template = $GLOBALS["_template"]->loadTemplate("squads", "memberslist_content_team_two", $data_array, $plugin_path);
                    echo $template;
                }
            ...
            $template = $GLOBALS["_template"]->loadTemplate("squads", "memberslist_content_foot", $data_array, $plugin_path);
            echo $template;
        }
        $data_array = array();
        $template = $GLOBALS["_template"]->loadTemplate("squads", "memberslist_foot", $data_array, $plugin_path);
        echo $template;
    } else {
    ...
    if (mysqli_num_rows($ergebnis)) {
        while ($ds = mysqli_fetch_array($ergebnis)) {
            ...
            while ($dm = mysqli_fetch_array($member)) {
                ...
                $town = strip_tags($dm['town']);
                if ($dm['activity']) {
                    $activity = '<span class="bg-success text-white">' . $plugin_language['active'] . '</span>';
                } else {
                    $activity = '<span class="bg-warning text-dark">' . $plugin_language['inactive'] . '</span>';
                }
                ...
                #if ($getavatar = getavatar($dm[ 'userID' ])) {
                ...
                if (isclanmember($dm['userID'])) {
                    $clanmember = ' <i class="bi bi-person" style="color:#5cb85c;"></i>';
                } else {
                    $clanmember = '';
                }
                ...
                $data_array['$squads_nickname'] = $plugin_language['nickname'];
                $data_array['$seeprofile'] = $plugin_language['profile'];
                $data_array['$squads_squad'] = $plugin_language['squad_name'];

                $template = $GLOBALS["_template"]->loadTemplate("squads", "memberslist_content", $data_array, $plugin_path);
                echo $template;
