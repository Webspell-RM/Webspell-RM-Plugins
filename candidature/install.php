...
$str                     =   "{[de]}Bewerbung{[en]}Candidature{[it]}Candidatura";// name of the plugin
$modulname               =   "candidature";                 // name to uninstall
$info                    =   "{[de]}Mit diesem Plugin könnt ihr eure ein Bewerbungsformular anzeigen lassen.{[en]}With this plugin you can display your application form. {[it]}Con questo plugin è possibile mostrare le Candidature  sul sito web.";	  // description of the plugin
$navi_name               =   "{[de]}Bewerbung{[en]}Candidature{[it]}Candidatura";// name of the Webside Navigation / Dashboard Navigation
$admin_file              =   "";              				      // administration file
$activate                =   "1";                           // plugin activate 1 yes | 0 no
$author                  =   "T-Seven";                     // author
$website                 =   "https://webspell-rm.de";      // authors website
$index_link              =   "candidature";     			      // index file (without extension, also no .php)
$hiddenfiles             =   "";                            // hiddenfiles (background working, no display anywhere)
$version                 =   "0.1";                         // current version, visit authors website for updates, fixes, ..
$path                    =   "includes/plugins/candidature/";  // plugin files location
##### Widget Setting ##################################################################################################################
...
$navi_link               =   "candidature";                 // navigation link file (index.php?site=...)
...
add_database_install($add_database_install = "CREATE TABLE IF NOT EXISTS`" . PREFIX . "plugins_candidature` (
