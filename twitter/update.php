...
$str                     =   "Twitter";                     // name of the plugin
$modulname               =   "twitter";                     // name to uninstall
$info                    =   "{[de]}Mit diesem Plugin könnt ihr eure twitter tweets anzeigen lassen.{[en]}With this plugin you can have your twitter tweets displayed.{[it]}Con questo plugin puoi visualizzare i tuoi tweet di Twitter.";// description of the plugin
$navi_name               =   "{[de]}Twitter{[en]}Twitter{[it]}Twitter";// name of the Webside Navigation / Dashboard Navigation
$admin_file              =   "admin_twitter";               // administration file
$activate                =   "1";                           // plugin activate 1 yes | 0 no
$author                  =   "T-Seven";                     // author
$website                 =   "https://webspell-rm.de";      // authors website
$index_link              =   "twitter,admin_twitter";       // index file (without extension, also no .php)
$hiddenfiles             =   "";                            // hiddenfiles (background working, no display anywhere)
$version                 =   "0.1";                         // current version, visit authors website for updates, fixes, ..
$path                    =   "includes/plugins/twitter/";   // plugin files location
##### Widget Setting ##################################################################################################################
$widget_link1            =   "widget_twitter_sidebar";      // widget_file (visible as module/box)
$widget_link2            =   "";                            // widget_file (visible as module/box)
$widget_link3            =   "";                            // widget_file (visible as module/box)
$widgetname1             =   "Twitter Sidebar";             // widget_name (visible as module/box)
...
$navi_link               =   "twitter";                     // navigation link file (index.php?site=...)
$catID                   =   "11";                          // dashboard_navigation category
$dashnavi_link           =   "admin_twitter";               // dashboard_navigation link file  (admincenter.php?site==...)
...
add_database_install($add_database_install = "CREATE TABLE IF NOT EXISTS`" . PREFIX . "plugins_twitter` (
  `twitterID` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(255) NOT NULL,
  `twitter_address` varchar(255) NOT NULL,
  `displayed` int(1) NOT NULL,
  `sort` int(14) NOT NULL,
