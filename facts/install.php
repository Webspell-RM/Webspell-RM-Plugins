...
$str                     =   "{[de]}Fakten{[en]}Facts{[it]}Fatti";              			// name of the plugin
$modulname               =   "facts";              			// name to uninstall
$info		             =   "{[de]}Mit diesem Plugin könnt ihr interessante Fakten und Details animiert darstellen.{[en]}With this plugin you can animated interesting facts and details.{[it]}Con questo plugin puoi animare fatti e dettagli interessanti.";	  	   // description of the plugin
$navi_name               =   "{[de]}Fakten{[en]}Facts{[it]}Fatti";		// name of the Webside Navigation / Dashboard Navigation
...
$path                    =   "includes/plugins/facts/";  		// plugin files location
##### Widget Setting ##################################################################################################################
$widget_link1            =   "widget_facts_content";				// widget_file (visible as module/box)
$widget_link2            =   "";     												// widget_file (visible as module/box)
$widget_link3            =   "";                            // widget_file (visible as module/box)
$widgetname1             =   "Facts Content";      					// widget_name (visible as module/box)
