...
$str                     =   "{[de]}Verknüpfen Sie uns{[en]}Link Us{[it]}I Nostri Link";                  	// name of the plugin
$modulname               =   "linkus";                  	// name to uninstall
$info                    =   "{[de]}Mit diesem Plugin könnt ihr eure Link Us anzeigen lassen.{[en]}With this plugin you can display your Link Us.{[it]}Con questo plugin puoi visualizzare il tuo Link Us.";// description of the plugin
$navi_name               =   "{[de]}Verknüpfen Sie uns{[en]}Link Us{[it]}I Nostri Link"; // name of the Webside Navigation / Dashboard Navigation
$admin_file              =   "admin_linkus";            	// administration file
$activate                =   "1";                           // plugin activate 1 yes | 0 no
$author                  =   "T-Seven";                     // author
$website                 =   "https://webspell-rm.de";      // authors website
$index_link              =   "linkus,admin_linkus"; 		// index file (without extension, also no .php)
$hiddenfiles             =   "";                            // hiddenfiles (background working, no display anywhere)
$version                 =   "0.1";                       // current version, visit authors website for updates, fixes, ..
$path                    =   "includes/plugins/linkus/";	// plugin files location
##### Widget Setting ##################################################################################################################
...
$navi_link               =   "linkus";                      // navigation link file (index.php?site=...)
$catID                   =   "12";                          // dashboard_navigation category
$dashnavi_link           =   "admin_linkus";                // dashboard_navigation link file  (admincenter.php?site==...)
...
add_database_install($add_database_install = "CREATE TABLE IF NOT EXISTS`" . PREFIX . "plugins_linkus` (
