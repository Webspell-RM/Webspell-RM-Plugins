...
$str                     =   "Topbar";                      // name of the plugin
$modulname               =   "topbar";                      // name to uninstall
$info                    =   "{[de]}Mit diesem Plugin können Sie eine Symbolleiste über der Navigationsleiste anzeigen{[en]}With this Plugin you can display a Toolbar above the Navigation Bar{[it]}Con questo Plugin puoi visualizzare un Toolbar sopra alla Barra di Navigazione";   // description of the plugin
$navi_name               =   "{[de]}Topbar{[en]}Topbar{[it]}Topbar";// name of the Webside Navigation / Dashboard Navigation
...
$path                    =   "includes/plugins/topbar/";    // plugin files location
##### Widget Setting ##################################################################################################################
$widget_link1            =   "widget_topbar_one";           // widget_file (visible as module/box)
$widget_link2            =   "widget_topbar_two";           // widget_file (visible as module/box)
$widget_link3            =   "widget_topbar_three";         // widget_file (visible as module/box)
$widgetname1             =   "Topbar One";                  // widget_name (visible as module/box)
$widgetname2             =   "Topbar Two";                  // widget_name (visible as module/box)
$widgetname3             =   "Topbar Three";                // widget_name (visible as module/box)
