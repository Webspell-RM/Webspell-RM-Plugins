...
$str                     =   "Navigation 2one";          	// name of the plugin
$modulname               =   "navigation_2one";          	// name to uninstall
$info		             =   "{[de]}Mit diesem Plugin könnt ihr euch die Navigation 2one anzeigen lassen.{[en]}With this plugin you can display the navigation 2one.{[it]}Con questo plugin puoi visualizzare la Barra di navigazione 2one.";// description of the plugin
...
$path                    =   "includes/plugins/navigation_2one/";  // plugin files location
##### Widget Setting ##################################################################################################################
$widget_link1            =   "widget_navigation_2one";   	// widget_file (visible as module/box)
$widget_link2            =   "";     						// widget_file (visible as module/box)
$widget_link3            =   "";                            // widget_file (visible as module/box)
$widgetname1             =   "Navigation 2one";          	// widget_name (visible as module/box)
