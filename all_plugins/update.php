...
$str                     =   "{[de]}Alle Plugins 1{[en]}All Plugins 1{[it]}Tutti i Plugins 1";// name of the plugin
$modulname               =   "all_plugins";                 // name to uninstall
$info                    =   "{[de]}Installionhilfe. Alle Plugins werden installiert{[en]}With this plugin it is possible to install all plugins{[it]}Con questo plugin è possibile visualizzare il vostro Chi Siam";// description of the plugin
$navi_name               =   "{[de]}Alle Plugins 1{[en]}All Plugins 1{[it]}Tutti i Plugins 1";// name of the Webside Navigation / Dashboard Navigation
...
$path                    =   "includes/plugins/all_plugins/";// plugin files location
##### Widget Setting ##################################################################################################################
