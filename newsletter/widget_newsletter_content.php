...
#$template = $GLOBALS["_template"]->loadTemplate("newsletter","widget_head", $data_array, $plugin_path);
#echo $template;
...
$template = $GLOBALS["_template"]->loadTemplate("newsletter","widget_content", $data_array, $plugin_path);
echo $template;
