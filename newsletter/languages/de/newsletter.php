...
$language_array = array(
    ...
    'request_mail'                => '<b>Du hast deinen Entfernungscode angefordert.</b><br><br>Um deine Mailadresse von der Mailing-Liste zu entfernen, klicke folgenden Link an: <a href="%homepage_url%/index.php?site=nletter&mail=%mail%&pass=%delete_key%">Mailadresse entfernen</a><br>Das Passwort zum Entfernen von der Liste lautet: %delete_key%<br><br>Bis demnächst auf %homepage_url%',
    'send'                        => 'Senden',
    'submit'                      => 'Abschicken',
    'success_mail'                => '<b>Vielen Dank für deine Anmeldung!</b><br><br>Wenn du deine Mailadresse von der Mailing-Liste entfernen willst, nutze bitte folgenden Link: <a href="%homepage_url%/index.php?site=nletter&mail=%mail%&pass=%delete_key%">Mailadresse entfernen</a><br>Das Passwort zum Entfernen von der Liste lautet: %delete_key%<br><br>Bis demnächst auf %homepage_url%',
