...
GLOBAL $theme_name;
    ...
    if (mysqli_num_rows($ergebnis)) {
        ...
        while ($db = mysqli_fetch_array($ergebnis)) {
            ...
            $data_array = array();
            $data_array['$sticky_pic'] = $sticky_pic;
            $data_array['$sticky_height'] = $sticky_height;
            $data_array['$title'] = $title;
            $data_array['$link'] = $link;
            $data_array['$description'] = $description;
            $data_array['$theme_name'] = $theme_name;
                
            $template = $GLOBALS["_template"]->loadTemplate("sticky_header","content", $data_array, $plugin_path);
            echo $template;
            $i++;
        }
    } else {
