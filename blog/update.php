...
if (mysqli_fetch_array(safe_query("SELECT * FROM Information_Schema.Columns WHERE Table_Name = '" . PREFIX . "plugins_blog' AND Column_Name = 'banner'"))){
echo '<div class="alert alert-info" role="alert">
Spalte banner existiert in Tabelle plugins_blog</div>';
}else{
echo '<div class="alert alert-success" role="alert">
Spalte banner existiert nicht und wird erstellt</div>';
safe_query("ALTER TABLE `".PREFIX."plugins_blog` ADD `banner` VARCHAR(255) NOT NULL");
}    
