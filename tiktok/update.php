...
$str                     =   "TikTok";                      // name of the plugin
$modulname               =   "tiktok";                      // name to uninstall
$info                    =   "{[de]}Mit diesem Plugin können Sie Tiktok-Videos auf der Website ansehen.{[en]}With this plugin you can view Tiktok Videos on the website.{[it]}Con questo plugin puoi visualizzare i Video di Tiktok sul sito web.";       // description of the plugin
$navi_name               =   "{[de]}TikTok{[en]}TikTok{[it]}TikTok";// name of the Webside Navigation / Dashboard Navigation
$admin_file              =   "admin_tiktok";                // administration file
$activate                =   "1";                           // plugin activate 1 yes | 0 no
$author                  =   "T-Seven mod by McRobert";     // author
$website                 =   "https://webspell-rm.de & https://www.blackangelteam.net";      // authors website
$index_link              =   "tiktok";                      // index file (without extension, also no .php)
$hiddenfiles             =   "";                            // hiddenfiles (background working, no display anywhere)
$version                 =   "0.1";                         // current version, visit authors website for updates, fixes, ..
$path                    =   "includes/plugins/tiktok/";    // plugin files location
##### Widget Setting ##################################################################################################################
$widget_link1            =   "widget_tiktok_sidebar";       // widget_file (visible as module/box)
$widget_link2            =   "";                            // widget_file (visible as module/box)
$widget_link3            =   "";                            // widget_file (visible as module/box)
$widgetname1             =   "TikTok Sidebar";              // widget_name (visible as module/box)
...
$navi_link               =   "tiktok";                      // navigation link file (index.php?site=...)
$catID                   =   "11";                          // dashboard_navigation category
$dashnavi_link           =   "admin_tiktok";                // dashboard_navigation link file  (admincenter.php?site==...)
...
add_database_install($add_database_install = "CREATE TABLE IF NOT EXISTS`" . PREFIX . "plugins_tiktok` (
  `tiktokID` int(11) NOT NULL AUTO_INCREMENT,
  `tiktok_name` varchar(255) NOT NULL,
  `tiktok_id` varchar(255) NOT NULL,
  `tiktok_title` varchar(255) NOT NULL,
  `displayed` int(1) NOT NULL,
  `displayedw` int(1) NOT NULL,
  `tiktok_height` varchar(255) NOT NULL,
