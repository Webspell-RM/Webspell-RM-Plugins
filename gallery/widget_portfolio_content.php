...
$template = $GLOBALS["_template"]->loadTemplate("gallery", "widget_portfolio_title_head", $data_array, $plugin_path);
echo $template;
...
if (mysqli_num_rows($cats)) {
    ...
    $template = $GLOBALS["_template"]->loadTemplate("gallery", "widget_portfolio_content_foot", $data_array, $plugin_path);
    echo $template;
}
