...
safe_query("ALTER TABLE `".PREFIX."plugins_gallery` ADD COLUMN IF NOT EXISTS number_of_images int(11) NOT NULL DEFAULT '10' AFTER `groupID`");
safe_query("ALTER TABLE `".PREFIX."plugins_gallery` ADD COLUMN IF NOT EXISTS images_per_page int(11) NOT NULL DEFAULT '4' AFTER `number_of_images`");
safe_query("ALTER TABLE `".PREFIX."plugins_gallery` ADD COLUMN IF NOT EXISTS sort INT NOT NULL AFTER `images_per_page`");

safe_query("ALTER TABLE `".PREFIX."plugins_gallery_pictures` ADD COLUMN IF NOT EXISTS sort INT NOT NULL AFTER `rating`");

safe_query("ALTER TABLE `".PREFIX."plugins_gallery_settings` ADD COLUMN IF NOT EXISTS images_per_page int(11) NOT NULL DEFAULT '4' AFTER `groups`");
