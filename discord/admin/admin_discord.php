...
$ergebnis = safe_query("SELECT * FROM ".PREFIX."navigation_dashboard_links WHERE modulname='discord'");
...
echo'<div class="card">
            <div class="card-header"> <i class="bi bi-discord"></i> ' . $plugin_language[ 'title' ] . '</div>
