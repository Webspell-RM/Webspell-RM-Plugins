...
$str                     =   "{[de]}Shoutbox{[en]}shoutbox{[pl]}shoutbox{[it]}Messaggi Shoutbox";                    // name of the plugin
...
$navi_name               =   "{[de]}Shoutbox{[en]}shoutbox{[pl]}shoutbox{[it]}Messaggi Shoutbox";  // name of the Webside Navigation / Dashboard Navigation
