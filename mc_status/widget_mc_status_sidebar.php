...
# Sprachdateien aus dem Plugin-Ordner laden
	...
	$plugin_language = $pm->plugin_language("mc_status", $plugin_path);
		...
		$data_array = array(); 
		$data_array['$lang_title']=$plugin_language['mc_status'];
		$template = $GLOBALS["_template"]->loadTemplate("mc_status","widget_title", $data_array, $plugin_path);
    	echo $template;
...
$name = $ds['name'];
			...
			$online = $GLOBALS["_template"]->loadTemplate("mc_status","widget_content", $data_array, $plugin_path);
			echo $online;
		}
		...
		$online = $GLOBALS["_template"]->loadTemplate("mc_status","widget_foot", $data_array, $plugin_path);
			echo $online;