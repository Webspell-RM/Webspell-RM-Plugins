...
$str                     =   "{[de]}Wer ist Online{[en]}Who is online{[it]}Chi è online";                 // name of the plugin
$modulname               =   "whoisonline";                   // name to uninstall
...
$navi_name               =   "{[de]}Wer ist Online{[en]}Who is online{[it]}Chi è online";// name of the Webside Navigation / Dashboard Navigation
$admin_file              =   "";              				        // administration file
$activate                =   "1";                             // plugin activate 1 yes | 0 no
$author                  =   "T-Seven";                       // author
$website                 =   "https://webspell-rm.de";        // authors website
$index_link              =   "whoisonline"; 				          // index file (without extension, also no .php)
$hiddenfiles             =   "";                              // hiddenfiles (background working, no display anywhere)
$version                 =   "0.1";                           // current version, visit authors website for updates, fixes, ..
$path                    =   "includes/plugins/whoisonline/"; // plugin files location
##### Widget Setting ##################################################################################################################
...
$navi_link               =   "whoisonline";                   // navigation link file (index.php?site=...)
