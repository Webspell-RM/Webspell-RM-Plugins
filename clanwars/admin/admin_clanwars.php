...
<input class="form-control" type="text" name="pic" size="50"
                ...
                <input class="btn btn-danger" type="button" onclick="MM_confirm(
                    ...
                    <script type="text/javascript">
    function MM_confirm(message, url) {
        if (confirm(message)) {
  ...
  if ($anz) {
    ...
    while ($ds = mysqli_fetch_array($qry)) {
      ...
      if (file_exists('includes/plugins/squads/images/games/' . $ds['game'] . '.jpg')) {
        $gameicon = '<img style="height: 100px" src="../includes/plugins/squads/images/games/' . $ds['game'] . '.jpg" alt="">';
      } elseif (file_exists('includes/plugins/squads/images/games/' . $ds['game'] . '.jpeg')) {
        $gameicon = '<img style="height: 100px" src="../includes/plugins/squads/images/games/' . $ds['game'] . '.jpeg" alt="">';
      } elseif (file_exists('includes/plugins/squads/images/games/' . $ds['game'] . '.png')) {
        $gameicon = '<img style="height: 100px" src="../includes/plugins/squads/images/games/' . $ds['game'] . '.png" alt="">';
      } elseif (file_exists('includes/plugins/squads/images/games/' . $ds['game'] . '.gif')) {
        $gameicon = '<img style="height: 100px" src="../includes/plugins/squads/images/games/' . $ds['game'] . '.gif" alt="">';
      } elseif (file_exists('includes/plugins/squads/images/games/' . $ds['game'] . '.avif')) {
        $gameicon = '<img style="height: 100px" src="../includes/plugins/squads/images/games/' . $ds['game'] . '.avif" alt="">';
      } elseif (file_exists('includes/plugins/squads/images/games/' . $ds['game'] . '.webp')) {
        $gameicon = '<img style="height: 100px" src="../includes/plugins/squads/images/games/' . $ds['game'] . '.webp" alt="">';
      } else {
