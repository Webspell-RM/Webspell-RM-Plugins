...
$str                     =   "Tags";                        // name of the plugin
$modulname               =   "tags";                        // name to uninstall
$info                    =   "{[de]}Mit diesem Plugin könnt ihr eure Tags anzeigen lassen.{[en]}With this plugin you can display your tags.{[it]}Con questo plugin puoi visualizzare i tag.";// description of the plugin
$navi_name               =   "{[de]}Tags{[en]}Tags{[it]}Tag";// name of the Webside Navigation / Dashboard Navigation
$admin_file              =   "";                            // administration file
$activate                =   "1";                           // plugin activate 1 yes | 0 no
$author                  =   "T-Seven";                     // author
$website                 =   "https://webspell-rm.de";      // authors website
$index_link              =   "tags";                        // index file (without extension, also no .php)
$hiddenfiles             =   "";                            // hiddenfiles (background working, no display anywhere)
$version                 =   "0.1";                         // current version, visit authors website for updates, fixes, ..
$path                    =   "includes/plugins/tags/";      // plugin files location
##### Widget Setting ##################################################################################################################
$widget_link1            =   "widget_tags_sidebar";         // widget_file (visible as module/box)
$widget_link2            =   "widget_tags_button_sidebar";  // widget_file (visible as module/box)
$widget_link3            =   "";                            // widget_file (visible as module/box)
$widgetname1             =   "Tags Sidebar";                // widget_name (visible as module/box)
$widgetname2             =   "Tags Button Sidebar";         // widget_name (visible as module/box)
