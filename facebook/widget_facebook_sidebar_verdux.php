...
if(mysqli_num_rows($sql)) {
    while($row = mysqli_fetch_array($sql)) {
        ...
        $template = $GLOBALS["_template"]->loadTemplate("facebook_verdux","widget_content_fb1", $data_array, $plugin_path);
        echo $template;
    }
}
...
if(mysqli_num_rows($sql)) {
    while($row = mysqli_fetch_array($sql)) {
            ...
            $data_array = array();
            $data_array['$facebook'] = $facebook;
        $template = $GLOBALS["_template"]->loadTemplate("facebook_verdux","widget_content_fb2", $data_array, $plugin_path);
        echo $template;
    }
}
...
if(mysqli_num_rows($sql)) {
    while($row = mysqli_fetch_array($sql)) {
            ...
            $data_array = array();
            $data_array['$facebook'] = $facebook;
        $template = $GLOBALS["_template"]->loadTemplate("facebook_verdux","widget_content_fb3", $data_array, $plugin_path);
        echo $template;
    }
}
...
if(mysqli_num_rows($sql)) {
    while($row = mysqli_fetch_array($sql)) {
            ...
            $data_array = array();
            $data_array['$facebook'] = $facebook;
        $template = $GLOBALS["_template"]->loadTemplate("facebook_verdux","widget_content_fb4", $data_array, $plugin_path);
        echo $template;
    }
}
    ...
    $data_array = array();
    $template = $GLOBALS["_template"]->loadTemplate("facebook_verdux","widget_foot_foot", $data_array, $plugin_path);
    echo $template;
}
?>