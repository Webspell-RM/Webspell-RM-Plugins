...
# Sprachdateien aus dem Plugin-Ordner laden
	...
	$plugin_language = $pm->plugin_language("features_box", $plugin_path);



    $data_array = array();
    $template = $GLOBALS["_template"]->loadTemplate("features_two_box","head", $data_array, $plugin_path);
    echo $template; 

    $data_array = array();
    $data_array['$title']=$plugin_language[ 'title' ];
    $data_array['$news-title']=$plugin_language['news-title'];
    $template = $GLOBALS["_template"]->loadTemplate("features_two_box","latesttopics_head", $data_array, $plugin_path);
    echo $template;
...
if ($anz) {
    ...
    while ($ds = mysqli_fetch_array($ergebnis)) {
        ...
        $template = $GLOBALS["_template"]->loadTemplate("features_two_box","latesttopics_content", $data_array, $plugin_path);
        echo $template; 
        $n++;
    }    
...
$data_array = array();
    $template = $GLOBALS["_template"]->loadTemplate("features_two_box","latesttopics_foot", $data_array, $plugin_path);
    echo $template;
...
#============================================================
    ...
    $template = $GLOBALS["_template"]->loadTemplate("features_two_box","headlines_head", $data_array, $plugin_path);
    echo $template;
...
if (mysqli_num_rows($ergebnis)) {
    ...
    while ($ds = mysqli_fetch_array($ergebnis)) {
        ...
        $line = '<a href="index.php?site=news_manager&action=news_contents&amp;newsID=$news_id" class="list-group">'.$headline.'</a>';
        ...
        $template = $GLOBALS["_template"]->loadTemplate("features_two_box","headlines_content", $data_array, $plugin_path);
        echo $template;
    ...
    unset($rubricID);
        ...
        $data_array = array();
        $template = $GLOBALS["_template"]->loadTemplate("features_two_box","headlines_foot", $data_array, $plugin_path);
        echo $template;
...
#==========================================================
    ...
    $template = $GLOBALS["_template"]->loadTemplate("features_two_box","files_head", $data_array, $plugin_path);
    echo $template;
...
if (mysqli_num_rows($ergebnis)) {
    ...
    while ($ds = mysqli_fetch_array($ergebnis)) {
        ...
        $template = $GLOBALS["_template"]->loadTemplate("features_two_box","files_content", $data_array, $plugin_path);
        echo $template;
    ...
    $data_array = array();
    $template = $GLOBALS["_template"]->loadTemplate("features_two_box","files_foot", $data_array, $plugin_path);
    echo $template;

    $data_array = array();
    $template = $GLOBALS["_template"]->loadTemplate("features_two_box","foot", $data_array, $plugin_path);
    echo $template; 
?>   
