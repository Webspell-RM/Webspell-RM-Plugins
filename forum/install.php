...
$transaction .= addtable("CREATE TABLE IF NOT EXISTS`" . PREFIX . "user_forum_groups` (
...
$transaction .= add_insert_table("INSERT IGNORE INTO `" . PREFIX . "user_forum_groups` (`usfgID`, `userID`, `1`) VALUES
(1, 1, 1)");
