...
<nav aria-label="breadcrumb">
  ...
  <div class="mb-3 row">
    ...
    $ds = mysqli_fetch_array(safe_query("SELECT * FROM " . PREFIX . "plugins_games_pic WHERE gameID='" . $_GET[ "gameID" ] . "'"));
        ...
        if(file_exists('./includes/plugins/games_pic/images/'.$ds['tag'].'.jpg')){
            $gameicon='<img style="height: 100px" src="../includes/plugins/games_pic/images/'.$ds['tag'].'.jpg" alt="">';
        } elseif(file_exists('./includes/plugins/games_pic/images/'.$ds['tag'].'.jpeg')){
            $gameicon='<img style="height: 100px" src="../includes/plugins/games_pic/images/'.$ds['tag'].'.jpeg" alt="">';
        } elseif(file_exists('./includes/plugins/games_pic/images/'.$ds['tag'].'.png')){
            $gameicon='<img style="height: 100px" src="../includes/plugins/games_pic/images/'.$ds['tag'].'.png" alt="">';
        } elseif(file_exists('./includes/plugins/games_pic/images/'.$ds['tag'].'.gif')){
            $gameicon='<img style="height: 100px" src="../includes/plugins/games_pic/images/'.$ds['tag'].'.gif" alt="">';
        } else{
...
<div class="mb-3 row">
    ...
    <div class="col-md-8">
      <a href="admincenter.php?site=admin_games_pic&amp;action=add" class="btn btn-primary" type="button">' . $plugin_language[ 'new_game_submit' ] . '</a>
    </div>
  </div>';
