...
$str                     =   "{[de]}Bilder update{[en]}Picture update{[it]}Aggiornamento immagini";              // name of the plugin
$modulname               =   "picupdate";                   // name to uninstall
$info                    =   "{[de]}Mit diesem Plugin könnt ihr Bilder hochladen, die ihr dann in eure Webseite einbauen könnt.{[en]}With this plugin, you can upload images that you can then incorporate into your website.{[it]}Con questo plugin puoi caricare immagini che potrai poi incorporare nel tuo sito web.";// description of the plugin
$navi_name               =   "{[de]}Bilder update{[en]}Picture update{[it]}Aggiornamento immagini"; // name of the Webside Navigation / Dashboard Navigation
$admin_file              =   "admin_pic_update";            // administration file
$activate                =   "1";                           // plugin activate 1 yes | 0 no
$author                  =   "T-Seven";                     // author
$website                 =   "https://webspell-rm.de";      // authors website
$index_link              =   "admin_pic_update";            // index file (without extension, also no .php)
$hiddenfiles             =   "";                            // hiddenfiles (background working, no display anywhere)
$version                 =   "0.1";                         // current version, visit authors website for updates, fixes, ..
$path                    =   "includes/plugins/picupdate/"; // plugin files location
##### Widget Setting ##################################################################################################################
...
$dashnavi_link           =   "admin_pic_update";            // dashboard_navigation link file  (admincenter.php?site==...)
...
add_database_install($add_database_install = "CREATE TABLE IF NOT EXISTS`" . PREFIX . "plugins_pic_update` (
  `picupdateID` int(10) NOT NULL AUTO_INCREMENT,
  `title` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `screens` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  PRIMARY KEY (`picupdateID`)
) AUTO_INCREMENT=1
