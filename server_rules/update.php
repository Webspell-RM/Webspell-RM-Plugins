...
$str                     =   "{[de]}Server Regeln{[en]}Server Rules{[it]}Regole Server";                  // name of the plugin
$modulname               =   "server_rules";                  // name to uninstall
$info                    =   "{[de]}Mit diesem Plugin könnt ihr eure Server Rules anzeigen lassen.{[en]}With this plugin you can display your server rules.{[it]}Con questo plugin è possibile mostrare le Regole del Server sul sito web.";// description of the plugin
$navi_name               =   "{[de]}Server Regeln{[en]}Server Rules{[it]}Regole Server"; // name of the Webside Navigation / Dashboard Navigation
$admin_file              =   "admin_server_rules";          // administration file
$activate                =   "1";                           // plugin activate 1 yes | 0 no
$author                  =   "T-Seven";                     // author
$website                 =   "https://webspell-rm.de";      // authors website
$index_link              =   "server_rules,admin_server_rules"; // index file (without extension, also no .php)
$hiddenfiles             =   "";                            // hiddenfiles (background working, no display anywhere)
$version                 =   "0.1";                         // current version, visit authors website for updates, fixes, ..
$path                    =   "includes/plugins/server_rules/";// plugin files location
##### Widget Setting ##################################################################################################################
...
$navi_link               =   "server_rules";                // navigation link file (index.php?site=...)
$catID                   =   "10";                          // dashboard_navigation category
$dashnavi_link           =   "admin_server_rules";          // dashboard_navigation link file  (admincenter.php?site==...)
...
add_database_install($add_database_install = "CREATE TABLE IF NOT EXISTS`" . PREFIX . "plugins_server_rules` (
...
add_database_install($add_database_install = "CREATE TABLE IF NOT EXISTS`" . PREFIX . "plugins_server_rules_settings` (
...
add_database_install($add_database_install = "INSERT IGNORE INTO `".PREFIX."plugins_server_rules_settings` (`server_rulessetID`, `server_rules`) VALUES (1, 5)"); 
