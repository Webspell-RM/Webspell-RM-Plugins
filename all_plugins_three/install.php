...
$str                     =   "{[de]}Alle Plugins 3{[en]}All Plugins 3{[it]}Tutti i Plugin 3";// name of the plugin
$modulname               =   "all_plugins_three";                 // name to uninstall
$info             		 =   "{[de]}Installionhilfe. Alle Plugins werden installiert{[en]}With this plugin it is possible to install all plugins{[it]}Con questo plugin è possibile Installare tutti i Plugin";// description of the plugin
$navi_name               =   "{[de]}Alle Plugins 3{[en]}All Plugins 3{[it]}Tutti i Plugin 3";// name of the Webside Navigation / Dashboard Navigation
...
$path                    =   "includes/plugins/all_plugins_three/";  // plugin files location
##### Module Startseite ###############################################################################################################
