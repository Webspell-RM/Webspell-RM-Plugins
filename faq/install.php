...
$str                     =   "FAQ";                    		  // name of the plugin
$modulname               =   "faq";                    		  // name to uninstall
$info                    =   "{[de]}Mit diesem Plugin könnt ihr eure FAQ anzeigen lassen.{[en]}With this plugin you can display your FAQ.{[it]}Con questo plugin puoi visualizzare le tue FAQ.";// description of the plugin
$navi_name               =   "{[de]}FAQs{[en]}FAQs{[it]}FAQs";        // name of the Webside Navigation / Dashboard Navigation
$admin_file              =   "admin_faq";              		  // administration file
$activate                =   "1";                           // plugin activate 1 yes | 0 no
$author                  =   "T-Seven";                     // author
$website                 =   "https://webspell-rm.de";      // authors website
$index_link              =   "admin_faq,faq";     			    // index file (without extension, also no .php)
$hiddenfiles             =   "";                            // hiddenfiles (background working, no display anywhere)
$version                 =   "0.1";                         // current version, visit authors website for updates, fixes, ..
$path                    =   "includes/plugins/faq/";  		  // plugin files location
##### Widget Setting ##################################################################################################################
...
$navi_link               =   "faq";                         // navigation link file (index.php?site=...)
$catID                   =   "7";                           // dashboard_navigation category
$dashnavi_link           =   "admin_faq";                   // dashboard_navigation link file  (admincenter.php?site==...)
...
add_database_install($add_database_install = "CREATE TABLE IF NOT EXISTS`" . PREFIX . "plugins_faq_categories` (
...
add_database_install($add_database_install = "CREATE TABLE IF NOT EXISTS`" . PREFIX . "plugins_faq` (
