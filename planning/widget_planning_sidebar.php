...
# Sprachdateien aus dem Plugin-Ordner laden
    ...
    $data_array = array();
    $data_array['$title']=$plugin_language['sc_planning'];
    $data_array['$subtitle']='Planung';
    $template_content = $GLOBALS["_template"]->loadTemplate("planning","sc_title", $data_array, $plugin_path);
...
if (mysqli_num_rows($ergebnis)) {
    ...
    $template_content = $GLOBALS["_template"]->loadTemplate("planning","sc_content_head", $data_array, $plugin_path);
	echo $template_content;
	...
	$template_content = $GLOBALS["_template"]->loadTemplate("planning","sc_content", $data_array, $plugin_path);
	echo $template_content;
	$x++;
	}
	$template_content = $GLOBALS["_template"]->loadTemplate("planning","sc_content_foot", $data_array, $plugin_path);
	echo $template_content;
} else {
