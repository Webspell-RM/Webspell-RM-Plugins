...
$ergebnis = safe_query("SELECT * FROM " . PREFIX . "plugins_features_box_two");
...
$template = $GLOBALS["_template"]->loadTemplate("features","box_two_content", $data_array, $plugin_path);
echo $template;

} else {
        
    echo $plugin_language[ 'no_features' ];
}