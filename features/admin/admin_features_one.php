...
if (isset($_POST[ 'submit' ])) {
    ...
    if ($CAPCLASS->checkCaptcha(0, $_POST[ 'captcha_hash' ])) {
        ...
        if (mysqli_num_rows(safe_query("SELECT * FROM " . PREFIX . "plugins_features"))) {
            safe_query("UPDATE " . PREFIX . "plugins_features SET title_one='" . $title_one . "', text_one='" . $text_one . "', title_two='" . $title_two . "', text_two='" . $text_two . "', title_three='" . $title_three . "', text_three='" . $text_three . "', title_four='" . $title_four . "', text_four='" . $text_four . "', title_six='" . $title_three . "', text_six='" . $text_six . "', features_box_chars='" . $features_box_chars . "' ");
        } else {
            safe_query("INSERT INTO " . PREFIX . "plugins_features (title_one, text_one, title_two, text_two, title_three, text_three, title_four, text_four, title_five, text_five, title_six, text_six, features_box_chars) values ( '" . $title_one . "', '" . $text_one . "', '" . $title_two . "', '" . $text_two . "', '" . $title_three . "', '" . $text_three . "', '" . $title_four . "', '" . $text_four . "', '" . $title_five . "', '" . $text_five . "', '" . $title_six . "', '" . $text_six . "', '" . $features_box_chars . "' ");
        }
...
echo'<div class="card">
        <div class="card-header">
            <i class="bi bi-person-vcard"></i> ' . $plugin_language[ 'nor_box' ] . '</div>
...
<div class="card-body">
    ...
    <form method="post" id="post" name="post" action="admincenter.php?site=admin_features" enctype="multipart/form-data" onsubmit="return chkFormular();">
