...
$str                     =   "{[de]}Mitglieder Liste{[en]}Members List{[it]}Lista Membri";   							// name of the plugin
$modulname               =   "memberslist";          				// name to uninstall
$info				     =   "{[de]}Mit diesem Plugin könnt ihr Mitglieder in Teams anzeigen lassen.{[en]}With this plugin you can display members in teams. {[it]}Con questo plugin puoi visualizzare i membri nei team.";// description of the plugin
$navi_name               =   "{[de]}Mitglieder Liste{[en]}Members List{[it]}Lista Membri";// name of the Webside Navigation / Dashboard Navigation
$admin_file              =   "";    												// administration file
$activate                =   "1";                           // plugin activate 1 yes | 0 no
$author                  =   "T-Seven";                     // author
$website                 =   "https://webspell-rm.de";      // authors website
$index_link              =   "memberslist";    							// index file (without extension, also no .php)
$hiddenfiles             =   "";                            // hiddenfiles (background working, no display anywhere)
$version                 =   "0.2";                       	// current version, visit authors website for updates, fixes, ..
$path                    =   "includes/plugins/memberslist/";// plugin files location
##### Widget Setting ##################################################################################################################
$widget_link1            =   "widget_memberslist_content";	// widget_file (visible as module/box)
$widget_link2            =   "";     												// widget_file (visible as module/box)
$widget_link3            =   "";                            // widget_file (visible as module/box)
$widgetname1             =   "Memberlist content";  				// widget_name (visible as module/box)
...
$navi_link               =   "memberslist";                 // navigation link file (index.php?site=...)
...
add_database_install($add_database_install = "CREATE TABLE IF NOT EXISTS`" . PREFIX . "plugins_memberslist` (
...
add_database_install($add_database_install = "INSERT IGNORE INTO `".PREFIX."plugins_memberslist` (`ruID`, `users`) VALUES ('1', '15')");
