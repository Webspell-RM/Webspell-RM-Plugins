...
$str                     =   "Navigation Sticky Navbar";    // name of the plugin
...
$path                    =   "includes/plugins/navigation_sticky_navbar/";  // plugin files location
##### Widget Setting ##################################################################################################################
$widget_link1            =   "widget_navigation_sticky_navbar";// widget_file (visible as module/box)
$widget_link2            =   "";                            // widget_file (visible as module/box)
$widget_link3            =   "";                            // widget_file (visible as module/box)
$widgetname1             =   "Navigation Sticky Navbar";    // widget_name (visible as module/box)
