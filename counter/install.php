...
$str                     =   "{[de]}Seitenstatistik{[en]}Counter{[it]}Statistiche Sito";                     // name of the plugin
$modulname               =   "counter";                     // name to uninstall
$info                    =   "{[de]}Mit diesem Plugin könnt ihr euch den Counter anzeigen lassen.{[en]}With this plugin it is possible to show the Counters on the website.{[it]}Con questo plugin è possibile mostrare i Contatori e le Statistiche del sito web.";// description of the plugin
$navi_name               =   "{[de]}Seitenstatistik{[en]}Counter{[it]}Statistiche Sito";// name of the Webside Navigation / Dashboard Navigation
$admin_file              =   "";                            // administration file
$activate                =   "1";                           // plugin activate 1 yes | 0 no
$author                  =   "T-Seven";                     // author
$website                 =   "https://webspell-rm.de";      // authors website
$index_link              =   "counter";                     // index file (without extension, also no .php)
$hiddenfiles             =   "";                            // hiddenfiles (background working, no display anywhere)
$version                 =   "0.2";                         // current version, visit authors website for updates, fixes, ..
$path                    =   "includes/plugins/counter/";   // plugin files location
##### Widget Setting ##################################################################################################################
$widget_link1            =   "widget_counter_sidebar";      // widget_file (visible as module/box)
$widget_link2            =   "";                            // widget_file (visible as module/box)
$widget_link3            =   "";                            // widget_file (visible as module/box)
$widgetname1             =   "Counter Sidebar";             // widget_name (visible as module/box)
...
$navi_link               =   "counter";                     // navigation link file (index.php?site=...)
