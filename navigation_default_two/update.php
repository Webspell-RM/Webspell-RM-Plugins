...
$str                     =   "{[de]}Navigationsstandard 2{[de]}Navigation Standard 2{[de]}Barra Standard di Navigazione 2";      // name of the plugin
$modulname               =   "navigation_default_two";      // name to uninstall
$info                    =   "{[de]}Mit diesem Plugin könnt ihr euch die Default Navigation 2 anzeigen lassen.{[en]}With this plugin you can display the default navigation 2.{[it]}Con questo plugin puoi visualizzare la Barra di navigazione predefinita 2. ";// description of the plugin
...
$path                    =   "includes/plugins/navigation_default_two/";  // plugin files location
##### Widget Setting ##################################################################################################################
$widget_link1            =   "widget_navigation_default_two";// widget_file (visible as module/box)
$widget_link2            =   "";                            // widget_file (visible as module/box)
$widget_link3            =   "";                            // widget_file (visible as module/box)
$widgetname1             =   "Navigation Default Two";      // widget_name (visible as module/box)
