...
$str                     =   "Navigation Agency";          	// name of the plugin
$modulname               =   "navigation_agency";          	// name to uninstall
$info		             =   "{[de]}Mit diesem Plugin könnt ihr euch die Navigation Agency anzeigen lassen.{[en]}With this plugin you can display the navigation Agency.{[it]}Con questo plugin puoi visualizzare la navigazione Agency. ";// description of the plugin
$navi_name               =   "{[de]}Agency Navi Header{[en]}Agency Navi Header";// name of the Webside Navigation / Dashboard Navigation
$admin_file              =   "admin_navigation_agency";     // administration file
...
$path                    =   "includes/plugins/navigation_agency/";// plugin files location
##### Widget Setting ##################################################################################################################
$widget_link1            =   "widget_navigation_agency";   	// widget_file (visible as module/box)
$widget_link2            =   "";     												// widget_file (visible as module/box)
$widget_link3            =   "";                            // widget_file (visible as module/box)
$widgetname1             =   "Navigation Agency";          	// widget_name (visible as module/box)
...
$dashnavi_link           =   "admin_navigation_agency";     // dashboard_navigation link file  (admincenter.php?site==...)
...
add_database_install($add_database_install = "CREATE TABLE IF NOT EXISTS`" . PREFIX . "plugins_navigation_agency` (
