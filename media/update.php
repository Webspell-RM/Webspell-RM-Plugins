...
$str                     =   "Media";                       // name of the plugin
$modulname               =   "media";                       // name to uninstall
$info                    =   "{[de]}Mit diesem Plugin könnt ihr eure Media anzeigen lassen.{[en]}With this plugin you can display your media.{[it]}Con questo plugin puoi visualizzare i tuoi contenuti multimediali.";// description of the plugin
$navi_name               =   "{[de]}Media{[en]}Media{[it]}Media";// name of the Webside Navigation / Dashboard Navigation
...
$path                    =   "includes/plugins/media/";     // plugin files location
##### Widget Setting ##################################################################################################################
$widget_link1            =   "widget_media_content";        // widget_file (visible as module/box)
$widget_link2            =   "";                            // widget_file (visible as module/box)
$widget_link3            =   "";                            // widget_file (visible as module/box)
$widgetname1             =   "Media Content";               // widget_name (visible as module/box)
