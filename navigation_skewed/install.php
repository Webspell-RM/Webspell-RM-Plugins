...
$str                     =   "Navigation Skewed";          // name of the plugin
$modulname               =   "navigation_skewed";          // name to uninstall
$info		             =   "{[de]}Mit diesem Plugin könnt ihr euch die Skewed Navigation anzeigen lassen.{[en]}With this plugin you can display Skewed navigation.{[it]}Con questo plugin puoi visualizzare la Barra di navigazione Skewed.";// description of the plugin
...
$path                    =   "includes/plugins/navigation_skewed/";  // plugin files location
##### Widget Setting ##################################################################################################################
$widget_link1            =   "widget_navigation_skewed";   	// widget_file (visible as module/box)
$widget_link2            =   "";     						// widget_file (visible as module/box)
$widget_link3            =   "";                            // widget_file (visible as module/box)
$widgetname1             =   "Navigation Skewed";          	// widget_name (visible as module/box)
